...
\textit{tldr; 1960s-70s. The urban development plans are ambitious plans for everything `urban', but also embedded in a broader, fully-developed national welfare state (not just the embrionic welfare city of the 1920s). Development plans coordinate a multitude of actors/investors and developments, and don't refrain from steering the market. The state is leading urban renewal, and not private investors.}
...
\bisection{General plans}\alignedmarginpar{Sweden as inspiration, fingerplans} started in 1920s, popularised post-WWII. Planning expanded, new suburban districts/satellite towns along transport stops, opening of subways, pedestrian and cycling paths, redevelopment of run-down city centres; all state led
...
\bisection{Coordination} urban dev plans need to coordinate developments and public actors actors, such as: government departments, local/regional departments, appointed agencies, private enterprises, community interests.
...
\bisection{State-driven urban renewal}\alignedmarginpar{Sweden's distinct housing regime} the rediscovering inner city centre, and gentrification movement was started earlier by the state; regional and urban agencies try to attract firms and influence the market

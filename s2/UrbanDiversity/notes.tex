...
\newgeometry{left=1cm,bottom=0.5cm,top=2.5cm}
%\section{Gentrification Hypotheses}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsubsection{Vienna's subsidised housing policies}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%& \raisebox{-0.9\totalheight}{\includegraphics[width=0.5\textwidth]{subsidised_stadterneuerung}} \\ 

\includegraphics[width=0.35\textwidth]{subsidised_stadterneuerung} &
\includegraphics[width=0.35\textwidth]{subsidised_apfelbaum} &
\includegraphics[width=0.35\textwidth]{architecture_mariafranchof} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \subsubsection{Transnational Migration and Tourism}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
...
\includegraphics[width=0.35\textwidth]{tourism_airbnb_sticker} &
\includegraphics[width=0.35\textwidth]{mariahilfer_starbucks_cities} &
 \includegraphics[width=0.35\textwidth]{mariahilfer_atlantis_flugreise} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsubsection{Urban Renewal Projects}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
...
\includegraphics[width=0.35\textwidth]{green_mariafranchof} &
\includegraphics[width=0.35\textwidth]{green_mariahilfer} &
 \includegraphics[width=0.35\textwidth]{green_hamerling} \\

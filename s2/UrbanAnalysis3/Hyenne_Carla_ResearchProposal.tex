...
I will pay special attention to socio-economic and personal characteristics such as age, gender, income, ethnicity, cultural practices, and general preferences in infrastructure and aesthetics.
% This will allow me to understand why people choose to frequent waterfronts, and how this shapes who uses what UBS in the city.

Specifically, I will be looking at three blue spaces in Copenhagen located in neighbourhoods with varying socio-economic and demographic profiles. A combination of ethnographies, surveys with users and interviews with experts will allow me to study a variety of perspectives on UBS. I will discuss the extent to which the city of Copenhagen offers equitable opportunities for people with different backgrounds and preferences to enjoy UBS, and juxtapose this against the ideal of the environmentally just city. 
...
Agyeman, J., Schlosberg, D., Craven, L., \& Matthews, C. (2016). Trends and directions in envi- ronmental justice: From inequity to everyday life, community, and just sustainabilities. Annual Review of Environment and Resources, 41, 321–340.

Anguelovski, I., Brand, A. L., Connolly, J. J., Corbera, E., Kotsila, P., Steil, J., Garcia-Lamarca, M., Triguero-Mas, M., Cole, H., Baro, F. et al. (2020). Expanding the boundaries of justice in urban greening scholarship: Toward an emancipatory, antisubordination, inter- sectional, and relational approach. Annals of the American Association of Geographers, 110(6), 1743–1769.
\end{comment}

...
%%%%%%%%%%%%%%%%%%%%
\subsection{The renewal of UBS}
%%%%%%%%%%%%%%%%%%%%

%%% Moving onto UBS revewal... how it started
...
% These need to be taken into account when providing new green or blue spaces in the city.

%%% Positive effects of UBS renewal
...
%%% Social consequences of UBS renewal

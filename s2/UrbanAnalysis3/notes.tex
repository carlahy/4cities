...
\begin{outline}
	...
	\1 Be significant enough to contribute to the existing body of research
	\1 Lead to further research
	\1 Render itself to investigation through collection of data
	\1 Be of interest to the research and suit their skills, time, resources
	\1 Lead to the research question
\end{outline}

\subsubsection{Problem statement}

A: \textit{The ideal condition} describes a desired goal or ideal situation; explains how things should be.

B: \textit{The real condition} describes a condition that prevents the goal, state, or value above from being achieved or realised at this time; explains how the current situation falls short of the goal or ideal. 

C: \textit{The consequences, conceptual and possibly practical} identifies the undesirable impacts - the problem - likely to occur if the real condition is not moved closer to the ideal.

Draft 1:

Environmental justice advocates for the equitable access to environmental benefits. \hl{TODO - better definition}
Open, public blue spaces in the city, such as rivers, canals, harbours and lakes, positively impact people's mental and physical wellbeing, much like green spaces do.

The planning and development of a blue space influence who uses the space, and how they use it. 
If waterfront projects are to contribute to making environmentally just cities, their design, from their location in the city to the built environment and furniture, have to respond to a criteria that accounts for social and environmental goals. 
The spaces should be designed to support a diversity of users and a diversity of uses.

Blue spaces which are not designed to be inclusive to people of different ages, genders, cultures, incomes, etc. reinforce inequalities within the city, and disproportionately affect the lower classes. On the contrary, high-quality blue spaces can contribute to creating healthier cities where diversity, inclusion, accessibility and safety are built-in by design.

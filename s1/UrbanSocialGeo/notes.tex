...
\begin{outline}
	...
	\1 \textbf{Performativity}
		\2 The insights that we produce shape realities
		\2 Are you in danger of reproducing the status quo?
		\2 But, we should probably not exaggerate the influence of academia

	\1 \textbf{Political economy critique}
		\2 State rescaling: a spatial restructuring of the nation-state due to globalisation, which changes the scale to supranational and subnational levels (Brenner)
...
Harvey (1989) proposes four ``entrepreneurial'' strategies that are being employed by policy makers, to navigate this crisis: production, consumption, redistribution, command and control
...
The British city (Kearsley), with council estate belts around the city.
\begin{center}
\includegraphics[width=20em]{kearsly}
\end{center}

The Chinese city (Burns), with villages within the city. People from the countryside migrate to the city, they can reside in these rural enclaves in cities. The formal and informal are very close together, there are `villages in the city' with many newcomers.

The African city (De Blij), where transport is slow and difficult; there are rich neighbourhoods in the city centre vs. poor, informal neighbourhoods on the outskirts. The city is marked by colonial past.

\begin{center}
\includegraphics[width=20em]{deblij}
\end{center}

Enclave urbanism (Mike Davis) like in LA in the 1990s (skid row, gated suburbs, Davis),

\begin{center}
\includegraphics[width=20em]{enclave}
\end{center}

The post-socialist city (Tallinn)
...
\begin{outline}
	\1 \textbf{Evenness} is the differential distribution of two social groups, among areal units in a city; a minority group is said to be segregated, if it is unevenly distributed over a given area. The \textbf{index of dissimilarity} measures the unevenness in population across space. If an index is low, it means that the population is evenly distributed (ie. less segregation), whereas if an index is 100, the population is unevenly distributed (ie. high segregation). 
	Ie, the proportion of a minority population that has to be moved, so that the composition of the sub-areas represents the overall demographic composition (concerning those two groups) of the city. In the most extreme case, both groups share not even a single neighbourhood, meaning that the index is 1 (100\%).
...
\subsubsection{Analytical shifts}

\begin{outline}
	\1 Analytical shift from the informal economy and everyday life tactics, to informal urbanism. There is a continued interest in labour questions, social embeddedness of economic relations, and interrelations of `informal' networks/communities and `formal' institutions
	\1 A diversification of topics: DIY urbanism, co-working spaces, gerilla gardening, co-housing, artistic interventions in public space, squatting, self-built housing,...
	\1 Beyond global South vs. North studies on cites: informal urbanism is global urbanism
	\1 Cultural infrastructure focus as implicit or explicit critique of focus on temporal use
\end{outline}

\subsection{Sensory urbanism, visual cultures and sound}

Media technologies and aesthetics shape urban places. In turn, this implies that places are experienced through multiple senses: seeing, listening, smelling, touching, tasting. Historically, most research has focused on the visual dimension. Increasingly, attention is being paid to other senses, such as music and sound. 

\begin{outline}
	\1 Starchitecture `adds value' to (aspiring) world cities
		\2 Cities become an urban icon in global rankings, become landscapes of tourism and consumption, sites for business investments, residential housing is upmarketed
		\2 Example: Eiffel tower, Sydney opera house, Guggenheim museum, world's tallest skyscrapers, Billionaire's row
	\1 Visual cultures: city branding, cultural tourism, (social) media
	\1 Geographies of circulation
		\2 City cultures are an effect of circulation
		\2 Architects and other experts are travelling, but also concepts, images, plans, best practices, etc.
		\2 Urban culture is a practice of `inter-referencing'
	\1 An increasing interest in other senses and the urban, such as auditory/sonic cultures
		\2 Brandon LaBelle (2010), \textit{Acoustic Territories: Sound Culture and Everyday Life} develops a ``view on walking through an auditory, rhythmic perspective''. Eg: crosswalk signals, warning alarms, personal audio while walking through the city, sound art, marching bands, protests,...
\end{outline}

\subsection{Conclusions}

\begin{outline}
	\1 Research on urban cultures is a thriving, inter/trans-disciplinary field of research
	\1 Building on the 1980s/1990s debates on the cultural turn, postmodern urbanism and the symbolic economy
	\1 Through interaction with urban anthropology and cultural studies: informal urbanism and everyday life
	\1 Urban studies has diversified into multiple strands of research dedicated to cultural issues, like arts/activism/urban engagement, cultural infrastructures/informal urbanism, sensory urbanism/visual cultures/sounds
\end{outline}
...
\subsubsection{Kleibert, \textit{On the global city map, but not in command? Probing Manila's position in the world city network}, 2016}

\begin{outline}
	\1 Cost-driven offshoring wrongly suggests a city's position in the world economy, especially as APS and financial services are offshored. Being present on the global cities map does not necessarily mean an increased command and control function
		\2 Thesis: the offshoring and resulting concentration of services does not lead to increased importance of the city, such that command and control does not follow APS
		\2 	Being on the map does not equate command and control
	\1 What kind of labor is being done? 
		\2 Low end activities
		\2 Internal division of labor
		\2 Centralization of core functions and decentralization of other functions, even within companies
	\1 Asymmetric integration: high degree of control elsewhere, and an uneven geography 
	\1 Literature comparison:
		\2 Sassen: dispersion as a key feature, but there is simultaneously dispersion and concentration; new scales related to central command functions; Kleibert questions if the existence of APS really leads to command function
		\2 Friedmann: few world cities as basing points for global capital
	\1 Post-colonial dimension?
		\2 Offshoring of services leading to an uneven and post-colonial world city network?
		\2 Agency of workers?
\end{outline}

\subsubsection{Krijnen, Bassens, van Meeteren, \textit{Manning circuits of value: Lebanese professionals and expatriate world-city formation in Beirut, 2016}}

\begin{outline}
	\1 Paper applies world city hypothesis to Beirut
	\1 Thesis: command and control, and human resources capacities, can be geographically dispersed while retaining their power capacity. Beirut `works' as a an expatriate global city through the social field
	\1 We need a new understanding: ``research should be sensitive to how APS professionals use their skills to seduce, manipulate and persuade investors to direct capital into their home environment in absence of financial centre functions''
	\1 A city as a node of knowledge, labor and network production
	\1 City as a sink for expatriate capital and a site of political lobbying
	\1 Literature comparison:
		\2 Friedmann: ?
		\2 Universities as a part of an economic system
		\2 Engaged instead of polemic pluralism
\end{outline}

\subsubsection{Olds, \textit{Pathways to global city formation: a view from the developmental city-state of Singapore}, 2004}

\begin{outline}
	\1 
\end{outline}

\subsubsection{Swyngedouw, Baeten, \textit{Scaling the city: the political economy of 'glocal' development - Brussels' Conundrum}, 2001}
...
\textit{Ref. remarkable highlights}

\begin{outline}
	\1 Introduction to urban geography: approaching the city, and cities for whom? 
\end{outline}
...
\subsubsection{Van Kempen \& Bolt, \textit{Social consequences of residential segregation and mixed neighbourhoods}}
...
\begin{outline}
	...
	\1 Socially unmixed neighbourhood pros:
		\2 Neighbourhood is important for poorer classes, because the socialisation between neighbours forms support networks. ``Neighbours have the opportunity for social interaction, for doing things together, and for helping each other - for example with a small loan ... Households with a lower income in general need survival strategies, and the neighbourhood can be of essential importance in that respect.'' (p. 443)
...
\subsubsection{Reigner, \textit{Safe, sustainable... but depoliticised and uneven - a critical view of urban transport policies in France}, 2019}

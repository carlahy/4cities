...
Why is there, or should be, a cultural turn? Interrelated claims
\begin{outline}
	\1 \textbf{Empirical}: culture is increasingly more important in advanced societies
	\1 \textbf{Theoretical}: we need better theories to grasp cultural dimensions of the social
	\1 \textbf{Methodological}: new methods to better interpret empirical data, or to interpret new data differently
...
Late 1980s to 1990s, these claims were being made more forcefully 

\subsection{Postmodernism and the city}

Literary and cultural theory: Fredric Jameson, \textit{The Cultural Turn}, \textit{Postmodernism}, 1984

Marxist literary 
Looks at the relation of culture to the political economy (a code word for capitalism)

\textbf{Postmodernism as the cultural logic of late capitalism}
...
The Bonaventura Hotel is for Jameson the culmination of late capitalism. It aspires to be a ``total space, a complete world'', with hidden entrances and \textbf{separate from the city}\footnote{Think about other elements of the city that exist in the space, but are actually separate: gated communities}. It's impossible to navigate postmodern hyperspace and situate yourself in reality.

Historicism effaces history; a recycling of the past, there is no linear trajectory  

\subsection{Los Angeles School of Urbanism}

Jameson was influential for cultural urban theories that came after words, such as the Los Angeles School of Urbanism.

Postmodern condition as a radically new urban condition, a \textbf{postmodern urbanism}. 

Strong sense of characterisation
LA as a privileged case for the research, but also considered LA as a prototypical type for the future cities across the world, specially on fragmentation and sprawl
Focus on restructuring: post-Fordism, flexible accumulation
...
\begin{outline}
	...
	\1 Political economy of place: element of the region, what does postmodernism mean for local labour and polarisation of labour markets (ref. Sassen)
...
It put LA on the map of urban studies. 

Keno Capitalism: shows in the extreme how artists looked at postmodernism
Argues that the spatial manifestation of postmodern urbanism is `keno capitalism', which is a board game; its a very fragmented form of urban structure. There is not center that extends outwards or central planning, but rather, random developments throughout the city.
Almost a parody of the debate, and taken to the extreme and simplification.
However, items on the map of keno capitalism resonate today: ethnoburbs, theme parks and spectacle (commodification of public space), gated communities, command and control centres (ref. Sassens, late capitalism)

\subsubsection{Critique of the LA School}

Generally, you have to be respectful of what came before. This is not what the LA School did.

- What's new? There is already existing work on diversity, restructuring, consumption and commodification, poverty
- It is wrong to reduce the Chicago School to Burgess' concentric zone mode
- There is an ethnographic void in a lot of literature on postmodern urbanism. It relies on a detached, top-down interpretation of the city; marginalises agency and interpretation of `ordinary people', and there is no postmodernism from below
- LA is not that radically different: first within LA, existing urban theories are still relevant to explain what is happening in LA; second, the empirical phenomena in LA are also visible elsewhere, and was happening before or earlier than when the LA School discussed it. LA isn't that special after all
...
\begin{outline}
	\1 Flexible accumulation, etc. are two sides of the same coin and are impossible to extract from one another; Marxist argument
	\1 Rise of postmodernism goes along with the rise of middle class; goes with rise of post fordism, etc. that created a new type of labour and population that was highly educated, well paying and intellectual jobs (the new middle class); they have new sensibilities and interests , and new lifestyle and consumption preferences
	\1 Culture is key to urban redevelopment: real estate, artists, representations of urban space; impact of gentrification on city spaces, are artists encouraging gentrification or being kicked out of gentrified areas?
	\1 Important role of the state: state investing in cultural landmarks, developing cultural and economic policies
\end{outline}

\subsubsection{Two sides of the same coin}

Paul Knox, \textit{The Restless Urban Landscape}
...
\begin{outline}
	...
	\1 Sociocultural: Generational reaction against modernist aesthetics and embracing instead postmodernism
	\1 Lifestyle orientation. Positively, art becomes part of everyday life, or critically, art is just showing off your identity
	\1 Commodity aesthetics: niche consumption (eg. wearing certain shoes, listening to some genre of music, installing flooring in a house will change between people but a niche scale) emphasised on taste and aesthetics, gives an increased role for design
\end{outline}

\subsection{Culture and urban redevelopment}

Zukin, \textit{Loft Living}, 1982:
\begin{outline}
	\1 New York oriented where there are lofts, but can be applied to a wider context
	\1 Argument: re-occupancy of abandoned structures by artists, followed by a new middle class (reconquest of the inner city), leading to a loft lifestyle which does not represent typical architectural style (eg. single family suburban home)
	\1 Competing uses: the remaining old tenants, the artists, and the middle class
	\1 Thus, when artists move in, it becomes more attractive for investors because the middle class may follow suit; hence, culture is used to develop and profit from emergent real estate market
	\1 Artists as drivers and victimes or urban development
\end{outline}
...
\begin{outline}
	...
	\1 State strategies: originally business driven, but nowadays picked up by states
		\2 Cultural and economic policies: strategies aimed at developing cultural industries, local economic development
...
So far, debate oriented towards urban geography, geographical concerns. The spatial term more broadly frames the debate.

The spatial turn:

Core themes in urban anthropology/cultural studies influencing the interdisciplinary urban studies:

\textbf{Informality} of (local) labour markets, precarious work, migration, legality, political governance and contestation.
Informal work: selling things in Las Ramblas and living a precarious life through informal work. Informal/formal is different from illegitimate/legitimate; for example, household work is informal but may not be illegitimate, compared to drug trafficking which is informal and more often considered illegitimate.

\textbf{Everyday life} on agency, community (building, resistance, consumption, identity, media and representation.
People as active, creative agents.
...
Cultural turn is understood as part of a wider shift in analytical sensibilities in the social sciences (?, theory, methods)

Urban geography as one strand of debate in this cultural turn, is heavily influenced by a Marxist interpretation of postmodernity as the cultural expression of late capitalism
...
Increasing rapprochement between urabn geography, cultural studies and anthropology as part of spatial turns.

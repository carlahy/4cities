...
\date{November 8th, 2021 - Nick Schuermans}

\subsection{The ideal of social mix}

The ideal of mixed neighbourhoods has been on political agendas
Supposed that segregation has a negative effect on poor people. You suffer more when you live in a neighbourhood stricken by poverty, than in another neighbourhood.

Different groups: \textbf{capitalist bourgeoisie} are afraid that the concentration of certain populations in a certain area in a city, would have negative effects, like leading to revolutions, socialist thinking would become dominant.
The \textbf{utopian socialists} were scared that the concentration of labourers would make it harder to strive for an egalitarian society.

This idea is still dominant nowadays and is high on the political agenda, worldwide, and across the whole political spectrum. $\Rightarrow$  \textbf{Social mobility and cultural integration}: there are concerns about the concentration of poor people, and people of foreign origin.

For example, in:

\begin{outline}
	\1  Brussels Capital Region: ``Contrary to the American city, the ideal type for the European city is based on a mix of functions and people''. $\rightarrow$ ideal cities require a mix of people (poor vs. rich), and of type (residential, commercial, offices, etc.). The concentration of `poor' people in one area, makes it harder for these populations to be socially mobile, and they would be better off if they were living in a mixed population in regards to wealth.
	\1 Ghent: attracting people with jobs will create a greater tax base, which will provide more capital to invest in the neighbourhood/city
	\1 Antwerp: regulation/efforts to designate what type of housing is desirable... ?
	\1 UK: Housing Market Renewal (HMR), neighbourhoods mainly inhabited by poor people were plagued by demolition projects and construction of new dwellings, such that these neighbourhoods are transformed such that the inhabitants are no longer disadvantaged by their neighbourhood, which makes it easier for the people to climb out of poverty
	\1 USA\marginpar{cfr. Slater}: Cabrini Green in Chicago, many apartment blocks were torn down and new houses built, to attract a middle class in a neighbourhood previously inhabited exclusively by poor
	\1 South Africa: 
\end{outline}

$\Rightarrow$ Is it possible to create socially mixed neighbourhoods, and do we want to?

\subsection{Is social mix feasible?}

Policies shift the poverty elsewhere spatially, and does not solve the issue. A metaphor is the waterbed effect, and the idea that ``moving chairs on the deck of the Titanic'', ie. the problem still exists but is just relocated.

Gentrification comes with displacement, such that low-income, low-skilled people leave gentrified cities like Brussels, towards cheaper and more industrial, disinvested areas. Cluster of highly educated people converge to Brussels; cluster of low-income people concentrate in industrial/manufacturing areas eg. Charleroi; 
This illustrates the ``moving chairs on the Titanic'', where the poor are moved around within Belgium, but still exist, and their condition does not change. It displaces people, and just moves poverty elsewhere.

$\Rightarrow$ Trying to create a social mix in some parts of the city, shifts poverty elsewhere, and will create other concentrations of poverty `down the street', eg. in Charleroi

Example of \textbf{inclusionary housing/inclusionary zoning} in Cadix, Eilandje (Antwerp):
...
The housing units could be sold off, but the criteria would have to remain. In this case, the social housing will remain forever as such, and will not `expire' eventually. The city could have made more money by selling off the land to private developers, but chose to do otherwise.

Thus, \textbf{is social mix feasible?} Yes, and projects, but it is hard to do in a situation where the market reigns.

\subsection{Is social mix desirable?}

\subsubsection{Neighbourhood effects}

Different geographers have been asking different research questions, and using different methods (qualitative vs. quantitative data, surveys), in regards to neighbourhood effects.

Every study on neighbourhood effects bear birthmarks: it matters where a study takes place. Literature on the effects of segregation in the USA has been used to influence policy in Eastern Europe, but the context is different - for one, the segregation context in the USA is stronger than it is in Europe, where the welfare state is much more developed. When it comes to poverty, and the eradication of poverty, this contextual difference is important, and the ideologies can not always be transferred as-is. 

Thus, such studies must be \textbf{provincialised, and contextualised}.

7 arguments for why it could matter whether you are a `poor' person living in a poor neighbourhood, or a mixed neighbourhood.

\subsubsection{Social network argument}

Connections between individuals, and the norms of reciprocity and  trustworthiness that arises from them
Bonding capital, between socially homogeneous people, eg. intra-ethnic
Bridging capital, between socially heterogeneous people, eg. inter-ethnic
Create mixed neighbourhoods, in order to create connections, such that poor people are better off

But, 
\begin{outline}
	\1 Increased mobility leads to human extensibility, leads to more networks outside of the neighbourhood. Eg. bonds developed with people from outside neighbourhood, especially at work or through kinship.
	\1 Parallel lives: will drawing white families to Molenbeek help the people there currently? People have a social network with people outside of the neighbourhood, with people with the same social class and education status. Thus, the middle class attracted to the neighbourhood will create connections with people similar to them, outside. This defeats the purpose of bringing middle class in, in the first place
	\1 Risks disrupting strong ties and bonding capital. Residents living in disinvested parts of the city, fall back on each other, ie. the bonding capital. Creating a mixed neighbourhood, by eg. attracting middle class, will displace the bonding capital that exists
\end{outline}

\subsubsection{Underclass argument}

Developed in the USA in 1980s, with two dominant thoughts:

\textbf{Structuralists} looked at structural forces for poverty in a declining economic base (eg. move from fordist to post-fordist society, leading to lack of employment)
\textbf{Culturalists} claim there is poverty because of a culture of poverty, with attitudes and behaviours that keeps people in their poverty.

In ghettos (ie. neighbourhoods with concentration of poor people), with unemployment, vice, crime, addiction, disfunction, are due to the \textbf{socialisation effects (peer group effects, lack of adult role models) and the physical infrastructure and institutional networks} within the neighbourhood.

But, 

\begin{outline}
	\1 Causality - neighbourhoods with concentration of drug use are located in the poor neighbourhoods; is this due to an uneven policing of poor neighbourhoods?
	\1 Socialisation outside neighbourhood
\end{outline}

\subsubsection{Social cohesion argument}

Living in a neighbourhood with a high concentration of foreign speakers, then you will not acquaint yourself as much with your new country's language and norms, and this will make it harder to climb the social ladder. $\Rightarrow$ Ethnic segregation and socioeconomic mobility arguments for creating social cohesion

But, 

\begin{outline}
	\1 Mobility? Is the neighbourhood the only place that such people can acquaint themselves with a new culture? There are many domains: home, work, leisure activities, where social mixity can take place
	\1 Importance of local culture: protective spaces to give people a safe place to be, especially when they are new 
\end{outline}

\subsubsection{Local services argument}
A presence of the middle class will attract services, like banks and ATMs, and prevent food deserts. Creating a mixed neighbourhood will attract a diverse set of shops and services.

But, 

\begin{outline}
	\1 More differentiation will also lead to a differentiated demand: will high mixity of people, and thus of businesses, some might not find what they are looking for; businesses might cater only to the middle class, and not the poor people, and thus displace the shops that previously existed and catered to low-income
	\1 Specialised services in arrival neighbourhood: will specialised shops and services (Thai, African...) remain?
	\1 Ethnic entrepreneurship 
\end{outline}

\subsubsection{Political argument}

Mixing neighbourhoods will put them higher on the political agenda, because middle class people are more listened to or have connections to politicians.
Of course the issue is, why do politicians not listen to the low-income populations in the first place?


\begin{outline}
	\1 ....
	\1 ....
	\1 \textbf{Spatial mismatch argument}: Concentration and clustering - in which part of the city is poverty concentrated? There is a mismatch between the location where people live, and where they could work (ie. where low-skilled jobs are available). 
		\2 But,
			\3 Public transport tends to be better in Western Europe, giving greater mobility
			\3 The language divide (eg. in Brussels, Flanders/Wallonia, do you need a specific language competency?)
	
	\1 \textbf{Stigmatisation argument}: Teachers and employers come into neighbourhoods with a stereotype/stigma, and will not give as good chances to the people living there than otherwise.
\end{outline}
...
movement of populations to other parts of the city, which are much worse and do not have the same services. 
Thus, the disadvantaged populations will not benefit from mixed neighbourhoods.

When thinking about promoting such policies, we need need to ask:
...
\textbf{Where, on what scale?}
The statistical units used to analyse segregation matters, eg. city vs. regional. And where, only in disadvantaged neighbourhoods? only in gentrifiable disadvantaged neighbourhoods? 
Why are we only concerned only with disadvantaged neighbourhoods, and not other municipalities where we could ask whether it is worth creating diversity there.
...
To counter racist stereotypes?, to improve the local tax base? Using the interest of poor people as rhetoric

...
\begin{outline}
	...
	\1 I had never heard of sanctuary cities, and I found it fascinating that a city like Chicago can declare itself as such, and make it illegal for police to ask about immigration status, and reduce funding for deportation enforcement. I would find it interesting to know how difficult it was for Chicago's mayor to enact this, and what effect it has had on the city. 
	Furthermore, what would a sanctuary city look in Europe, ie. outside of the US? What conditions tip a city to be a sanctuary city, compared to another? For example, how does the political climate in Brussels, prevent it from being a sanctuary city and worst, makes it the complete opposite: Brussels pushes towards raids in immigrant neighbourhoods and ID checks in public space (p. 387)?

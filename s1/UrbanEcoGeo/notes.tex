...
\begin{outline}
	...
	\1 ``The rent gap is the disparity between the potential ground rent level and the actual ground rent capitalized under the present land use'', ''only when this gap emerges can redevelopment be expected since if the present use succeeded in capitalizing all or most of the ground rent, little economic benefit could be derived from redevelopment'' (p. 545)
\end{outline}

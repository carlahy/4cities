...
Informality is not just about the urban poor, but a mode of urbanisation that takes distance from urban (planning) rules and regulations.
Informality is a key dimension of \textbf{subaltern urbanism}.

For example, popular settlements on the fringes of Mexico City; the city is fast expanding, and most of the metropolitan expansion is being driven by informal urbanisation. 

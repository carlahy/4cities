...
Inhabitants aren't only residents, but all city users. 
For example, Las Ramblas: how are these kind of spaces produced? By businesses, shops, tourists, transport companies bringing people to Barcelona, city marketing campaigns to attract tourists in a view of development of local economy.
Tourists themselves are involved in the production of this space, both symbolically and physically. The shops and the people (predominantly tourists) would not be there, if it weren't for the tourists.
In contrast, there is another category of city users who use the space for living purposes. There is a conflict between the residents, and the tourists; those who sleep at night, and those who live at night. Thus, there are conflicting ways to use space. 

Thus, through ordinary uses of space, us city users have a (collective) role in the production of space.

\subsection{Learning from above and from below}

Ananya Roy, \textit{The 21st century metropolis: New Geographies of Theory}, 2009. 
Speaks about the importance of grassroots, informal, ``from below'' movements and concepts regarding inhabitants and the city.

Learning from above: Urban political economy researches cities and urban change ``from above''
Learning from below: from the perspective of the governed, rather than from the perspective of those in the public/private governing seats

\subsection{Ordinary cities}

Jennifer Robinson, \textit{Ordinary Cities}, 2006.

Manies cities are left off the map, as a consequence of ?. Hence, they are implicitly deemed places to not learn anything from.
Think about global cities: Africa has only a handful of cities represented on the GaWC heuristics map, and the majority are concentrated Western Europe, Northern America, and Japan.

Thus, very large cities are not included on this map. Global cities promotes economic relations, with global reach, and ``prioritises certain prominent sectors of the global economy for development and investment''.  \marginpar{Astana global city aspirations?}

To escape this trap, Robinson proposes to look at cities are `ordinary', and not as global or invisible. This is a heuristic proposal, and not a call for completing the map of global cities by adding a new category to the same map. Rather, to create a new map where all cities are allowed to be `ordinary', including NYC, London, Tokyo, etc. 

This focuses on other realities of the city.

A call for \textbf{cosmopolitanisation or provincialisation} of cities, to theorise, (re) build concepts, take inspiration from a wider range of cities and not just the Global North cities. 

The foundation for \textbf{post-colonial urban studies}:
...
\begin{outline}
	...
	\1 More attention for grassroots, everyday, informal, DIY, etc. dimensions of urbanisations
	\1 Pay more attention for the everyday livles of the urban poor, eg. in favelas, townships, slums, gecekondu
\end{outline}

An epistemological proposal: how do we learn and produce knowledge, by looking at what?

Boaventura de Sousa Santos, \textit{Epistemologies of the South}

Other notions in line with the call for post-colonial urban studies: subaltern urbanism, occupancy urbanism, popular urbanisation, peripheral urbanisation, insurgent citizenship, popular centrality, etc.

\subsection{Subaltern urbanism}

Ananya Roy: need to contest inherited location of urban theoretical work, which has been done predominantly in the center of the colonial power rather than colonised country. In 21st century, the fastest growing cities are in the global South.

The point is to study cities differently, starting from a city in the global South, to get a different grip on urban reality. The point is not to study global South cities instead of global North cities, but to start from a different place, because \textbf{any city can be a place for theory-making}.

The argument is about the situatedness of urban theory. This does not mean that theories are not applicable to contexts outside of the ones they were created.
...
\begin{outline}
	\1	Different norms: squatter settlements at the rural and urban interface, or elite zones
	\1 Main criteria: the distance from formal spatial planning rules or land regulations
\end{outline}

\textbf{Informality} is not just about the urban poor, but a mode of urbanisation that takes distance from urban (planning) rules and regulations.
Informality is a key dimension of \textbf{subaltern urbanism}.

Examples:

\begin{outline}
	\1 Popular settlements on the fringes of \textbf{Mexico City}; the city is fast expanding, and most of the metropolitan expansion is being driven by informal urbanisation. Producing knowledge first in the global South, and let this concept travel.
	\1 \textbf{Cureghem}: (informal/illegal) street vendors near metro stations, informal housing practices through illegal subletting and slum lords, (formal/informal) Sunday markets, Rue Heyvart street second hand car negotiations. 
		\2 Master Plan PAD Heyvart: linear park cutting through neighbourhood, forcing garages to move; part of the redevelopment of the canal, to attract startups and business; idea is to transform the abattoir (and more), to have activities more in line with the aspirations of the new middle class rather than the the aspirations of those who already live there\marginpar{Photo essay Porte de Ninove}
		\2 Thus, Cureghem is a space produced both from above and from below, notably by inhabitants in diverse \textbf{subaltern} positions developing and relying on informal practices.
\end{outline}
...
Urban informality is not outside the scope of capital: ancillary parts of the formal markets, eg. food, second hand cars, housing.
...
Reveals the \textbf{collective} agency of the population in the production of space, through collective experiences, including mobilisations (eg. claiming land, getting access to services that are denied/not offered by public or private institutions).

\textbf{Gecekondu}, Turkey. ``Settling at night'', originally informal settlements built overnight by rural-to-urban immigrants, on illegally occupied land. The term now includes diverse kinds of informal settlements.
...
Towards a post-gecekondu city: using earthquakes as argument for destruction and reconstruction of dwellings, a justification for `cleaning' the place by forcing people to sell their homes or face expropriation... although one of the towers that was built anew collapsed in an earthquake in 20XX (?), reinforcing the idea that the destruction/construction is not to protect the population from earthquakes.

Lamekan: attracting foreign direct investments through construction and finance sectors\marginpar{Astana}

\subsubsection{The city from below}

Rosa Bonheur, \textit{La ville vue d'en bas}, 2019

Roubaix: example of shrinking city, hit by deindustrialisation. In 19th century, Roubaix was a `Manchester' with industrial textile production, ``la ville aux mille cheminées''. 
Municipality purchased (run down) houses and proposed to sell it for 1 euro, and the buyer had the responsibility of renovating. But, selling houses at 1 euro depreciates the value of the houses next door, thus was not really efficient. But, it shows that Roubaix is a place where renewal programs were implemented to try to reinvigorate the city, eg. subsidies for attracting companies, middle class neighbourhoods, urban gardens, etc.

\textbf{Subsistence work}: 
...
\begin{outline}
	...
	\1 Shopping works: organisation of mobilities to get decent food, clothing, equipment, at a low cost; people organising across long distances to get resources, for example travelling in one car from Lille to Cureghem to buy cheap meat for multiple families; ie. sharing resources
	\1 Paper works: 
	\1 Economic activities that provide income and meet local, low budget demands; eg. street car mechanics
\end{outline}

Subsistance work is \textbf{spatial}, relies to spatial configurations that make it possible for the work to exist. And it helps to reproduce these spaces. 

\[\textbf{Subsistence work $\leftrightarrow$ popular centrality}\]

\subsection{Popular centrality}

A resourceful space, a space made by and for those who are using it. It is a resource in the sense that it is constantly produce and consumed by those involved, in a relation.
...
\textbf{Popular}: set of social spaces made for and by populations in socially-dominated positions

\textbf{Centrality}: those spaces are absolutely central to the daily lives of the populations using it. Contrast with the planning documents which look like peripheral neighbourhoods that need to be reconnected to the city center; But if you look at it from below, this is false. There is a strong community and life happening in these neighbourhoods, that do not need any connection to the city centres.\marginpar{Photo essay: porte de Ninove is embedded in a neighbourhood that has popular centrality, yet developments targeting middle class are being developed}

How some places resist gentrification? Popular centrality is a \textbf{resistance space}.
...
\begin{outline}
	...
	\1 Marolles flea market (including professionals), Place du jeux de balle, taking place every morning. A space of intense sociability and economic action, a multi-purpose space.  popular centrality.
	\1 Successful protest against the parking project in the Marolles, which would have replaced the market; 
\end{outline}

The flea market is used as a promotion for the city, by the city.

Production from below can produce resistance spaces

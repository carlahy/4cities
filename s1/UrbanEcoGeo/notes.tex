...
Most often, the private contractors have DBFM-O contracts. This means they design, build, finance, maintain and operate the project, via a dedicated project-based operating structure, against the payment of a yearly feel due for a fixed period (eg. 25 years).\marginpar{Are Astana buildings PPP?}
...
Contra arguments:
\begin{outline}
	\1 More costly for public finance in the long term, compared to a classic bank loan; you have to pay the contractor, plus their profit because private contractor seeks a return on investment
...
\begin{outline}
	\1 1. Invest locally in cultural externalities
	...
	\1 2. Expect a wide range of beneficial impacts

...
When and where has FFTP developed?
...
\begin{outline}
	...
	\1 Privatisation and reduction of costs?
		\2 FFTP is closely related to privatisation of public transport networks, and FFTPs created bad working conditions for workers (long hours and low pay)
\end{outline}

\subsubsection{Conclusion}

\begin{outline}
	\1 FFTP seems like a simple, uniform idea but in reality is not always. The implementations are highly context specific, and mean

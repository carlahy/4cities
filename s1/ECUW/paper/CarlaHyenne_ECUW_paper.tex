...
% Indeed,  2018 marked the first year Astana was listed as a global city on the GaWC (Globalisation and World Cities) list, if only as ``sufficient'' \parencite{gawc2018list}. 

...
\textit{$\rightarrow$ Todo: add figure with x axis=years, y axis=on one side GRP contributions for 5 biggest sectors in million tenge, on the other side=employment numbers for 5 largest sectors>}
...
As we have seen, Astana's economy and society was definitely shaped by post-socialism. However, the social inequalities today are not as pronounced as they were in the 1990s, \textit{$\rightarrow$ todo: more examples.}
